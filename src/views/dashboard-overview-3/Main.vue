          ...
          <div class="mt-14 mb-3 grid grid-cols-12 sm:gap-10 intro-y">
            ...
            >
              ...
              >
                ...
                <div class="dropdown-menu w-40">
                  <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                    ...
                    >
                      <FileTextIcon class="w-4 h-4 mr-2" />Monthly Report
                    </a>
                    <a
                      href
                      class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"
                    >
                      <FileTextIcon class="w-4 h-4 mr-2" />Annual Report
                    </a>
                  </div>
                </div>
              </div>
              <div class="text-sm 2xl:text-base font-medium -mb-1">
                Hi Angelina,
                <span
                  class="text-gray-700 dark:text-gray-500 font-normal"
                >welcome back!</span>
              </div>
              <div
            ...
            >
              <div class="flex flex-wrap items-center">
                ...
                >
                  ...
                  <div class="ml-3.5">
                    ...
                    <div
                      class="text-gray-600 dark:text-gray-600 mt-2"
                    >Yearly budget</div>
                  </div>
                </div>
                <select
              ...
              <div
                class="mt-10 text-gray-700 dark:text-gray-500"
              >You have spent about 35% of your annual budget.</div>
                ...
                >
                  <div class="relative">
                    ...
                    >
                      ...
                      <div
                        class="text-gray-600 dark:text-gray-600 mt-0.5"
                      >Active Users</div>
                    </div>
                  </div>
            ...
            >
              ...
              <div class="flex items-center justify-center mt-10">
                <div class="text-right">
                  ...
                  <div
                    class="truncate mt-1 text-gray-600 dark:text-gray-600"
                  >Active Lenders</div>
                </div>
                <div
              ...
              <div class="max-h-full xl:overflow-y-auto box mt-5">
                ...
                >
                  <div class="flex items-center">
                    ...
                    >
                      <RefreshCcwIcon class="w-4 h-4 mr-3" />Refresh
                    </a>
                  </div>
                  <div
          ...
          <div class="col-span-12 mt-6">
            <div class="intro-y block sm:flex items-center h-10">
              ...
              <div class="flex items-center sm:ml-auto mt-3 sm:mt-0">
                ...
                >
                  <FileTextIcon class="hidden sm:block w-4 h-4 mr-2" />Export to Excel
                </button>
                <button
                  class="ml-3 btn box flex items-center text-gray-700 dark:text-gray-300"
                >
                  <FileTextIcon class="hidden sm:block w-4 h-4 mr-2" />Export to PDF
                </button>
              </div>
            </div>
              ...
              <div class="report-timeline mt-5 relative">
                <div class="intro-x relative flex items-center mb-3">
                  ...
                  <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                    <div class="flex items-center">
                      <div class="font-medium">{{ $f()[9].users[0].name }}</div>
                ...
                <div class="intro-x relative flex items-center mb-3">
                  <div class="report-timeline__image">
                    ...
                    >
                      <img
                        alt="Icewall Tailwind HTML Admin Template"
                        :src="`/src/assets/images/${$f()[8].photos[0]}`"
                      />
                    </div>
                  </div>
                  <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                    <div class="flex items-center">
                      <div class="font-medium">{{ $f()[8].users[0].name }}</div>
                      <div class="text-xs text-gray-500 ml-auto">07:00 PM</div>
                    </div>
                      ...
                      <div class="flex mt-2">
                        ...
                        >
                          <img
                            ...
                            :src="`/src/assets/images/${$f()[8].images[0]}`"
                          />
                        </Tippy>
                        <Tippy
                          tag="div"
                        ...
                        >
                          <img
                            alt="Icewall Tailwind HTML Admin Template"
                            class="rounded-md border border-white"
                            :src="`/src/assets/images/${$f()[8].images[1]}`"
                          />
                        </Tippy>
                        <Tippy
                          tag="div"
                        ...
                        >
                          <img
                            alt="Icewall Tailwind HTML Admin Template"
                            class="rounded-md border border-white"
                            :src="`/src/assets/images/${$f()[8].images[2]}`"
                          />
                        </Tippy>
                      </div>
                    </div>
                ...
                <div
                  class="intro-x text-gray-500 text-xs text-center my-4"
                >12 November</div>
                <div class="intro-x relative flex items-center mb-3">
                  <div class="report-timeline__image">
                    <div
                    ...
                    >
                      <img
                        alt="Icewall Tailwind HTML Admin Template"
                        :src="`/src/assets/images/${$f()[7].photos[0]}`"
                      />
                    </div>
                  </div>
                  <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                    <div class="flex items-center">
                      <div class="font-medium">{{ $f()[7].users[0].name }}</div>
                      <div class="text-xs text-gray-500 ml-auto">07:00 PM</div>
                    </div>
                ...
                <div class="intro-x relative flex items-center mb-3">
                  <div class="report-timeline__image">
                    ...
                    >
                      <img
                        alt="Icewall Tailwind HTML Admin Template"
                        :src="`/src/assets/images/${$f()[6].photos[0]}`"
                      />
                    </div>
                  </div>
                  <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                    <div class="flex items-center">
                      <div class="font-medium">{{ $f()[6].users[0].name }}</div>
                      <div class="text-xs text-gray-500 ml-auto">07:00 PM</div>
                    </div>
                    <div class="text-gray-600 mt-1">
                      Has changed
              ...
              <div class="mt-5">
                ...
                >
                  <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                    ...
                    >{{ faker.trueFalse[0] ? '+' : '-' }}${{ faker.totals[0] }}</div>
                  </div>
                </div>
                <a
                  href
