      ...
      <div class="container grid grid-cols-1 md:grid-cols-2 px-5 py-10">
        <div class="grid">
          <div class="md:ml-16 my-auto">
            ...
            >
              The all you need app for your coffee craving.
            </h1>
            <div class="hidden md:flex">
              ...
              <a :href="playStore" class="md:ml-16">
                <img
                  class="w-11/12"
    ...
    <section class="mt-6 lg:mt-10">
      <div class="container md:flex md:gap-10">
        ...
        <div class="box p-5 md:p-10 md:basis-1/2 grid mt-6 md:mt-0">
          ...
          />
          <h1 class="text-3xl md:text-5xl">
            Support your local café and get rewarded with loyalty cashback on
            your orders.
          </h1>
        </div>
      </div>
      ...
      <div class="container md:flex md:gap-10">
        <div class="box p-5 md:p-10 md:basis-1/2 grid">
          ...
          <div class="row-span-1 xl:pt-10">
            <h1 class="text-3xl md:text-5xl">
              Set a budget for your spendings and auto refill your balance as
              needed.
            </h1>
          </div>
        </div>
        <div class="box p-5 md:p-10 md:basis-1/2 grid mt-6 md:mt-0">
          ...
          <div class="row-span-1 xl:pt-10">
            <h1 class="text-3xl md:text-5xl">
              Local food deliveries at participating coffee shops.
            </h1>
          </div>
        </div>
      </div>
      ...
      <div class="container pt-10">
        <div class="apps">
          <div class="flex flex-col text-center">
            ...
            <h1 class="text-3xl md:text-7xl font-bold mt-5">
          ...
          <div class="flex flex-col md:flex-row justify-center pt-8 md:pt-16">
            <div class="flex justify-between mt-5">
              ...
              <a :href="playStore" class="md:ml-20">
                <img
                  class="ml-auto"
                  src="@/assets/images/Google_Play_Badge.png"
                  alt="Google_Play_Badge"
