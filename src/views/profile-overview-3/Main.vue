            ...
            <div class="p-5">
              <div class="relative flex items-center">
                ...
                <div class="ml-4 mr-auto">
                  ...
                  <div
                    class="text-gray-600 mr-5 sm:mr-5"
                  >Bootstrap 4 HTML Admin Template</div>
                </div>
              ...
              <div class="relative flex items-center mt-5">
                ...
                <div class="ml-4 mr-auto">
                  ...
                  <div
                    class="text-gray-600 mr-5 sm:mr-5"
                  >Tailwind HTML Admin Template</div>
                </div>
          ...
          <div class="intro-y box col-span-12 2xl:col-span-6">
            ...
            <TinySlider ref-key="todaySchedulesRef" class="py-5">
              <div class="px-5 text-center sm:text-left">
                ...
                >Developing rest API with Laravel 7</div>
                <div class="text-gray-700 dark:text-gray-600 mt-2">
                  Lorem Ipsum is simply dummy text of the printing and
                ...
                <div class="flex flex-col sm:flex-row items-center mt-5">
                  <div class="flex items-center text-gray-600">
                    <MapPinIcon class="hidden sm:block w-4 h-4 mr-2" />1396 Pooh Bear Lane, New Market
                  </div>
                  <button
            ...
            <div class="p-5">
              ...
              >
                ...
                <a
                  ...
                  aria-selected="false"
                >
                  <InboxIcon class="block w-6 h-6 mb-2 mx-auto" />Symfony
                </a>
                <a
                  ...
                  aria-selected="false"
                >
                  <ActivityIcon class="block w-6 h-6 mb-2 mx-auto" />Bootstrap
                </a>
              </div>
