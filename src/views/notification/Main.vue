              ...
              <div class="text-center">
                ...
                >
                  ...
                  <div class="ml-4 mr-4">
                    ...
                    >The message will be sent in 5 minutes.</div>
                  </div>
                </div>
                <!-- END: Notification Content -->
                <!-- BEGIN: Notification Toggle -->
                ...
                >
                  ...
                  <div class="ml-4 mr-4">
                    ...
                    <div class="text-gray-600 mt-1">
                      ...
                      <br />changes during the update process!
                    </div>
                    <div class="font-medium flex mt-1.5">
                      <a
                        class="text-theme-1 dark:text-gray-500"
                        href
                      >Restart Now</a>
      ...
      <div class="intro-y col-span-12 lg:col-span-6">
        ...
        <div class="intro-y box mt-5">
          ...
          >
            ...
            >Notification With Split Buttons</h2>
            <div
              class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0"
            >
              <label
        ...
        <div class="intro-y box mt-5">
          ...
          >
            <h2
              class="font-medium text-base mr-auto"
            >Notification With Buttons Below</h2>
            <div
              class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0"
            >
              <label
