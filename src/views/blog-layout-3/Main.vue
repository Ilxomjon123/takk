<template>
  <div>
    <div class="intro-y news xl:w-3/5 p-5 box mt-8">
      <!-- BEGIN: Blog Layout -->
      <h2
        class="intro-y font-medium text-xl sm:text-2xl"
      >{{ $f()[0].news[0].title }}</h2>
      <div
      ...
      <div class="intro-y flex relative pt-16 sm:pt-6 items-center pb-6">
        ...
        >
          ...
          <div class="intro-x mr-1 sm:mr-3">
            Views:
            <span class="font-medium">{{ $f()[0].totals[1] }}k</span>
          </div>
          <div class="intro-x sm:mr-3 ml-auto">
            Likes:
            <span class="font-medium">{{ $f()[0].totals[2] }}k</span>
          </div>
        </div>
        <Tippy
          tag="a"
