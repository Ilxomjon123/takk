          ...
          <div class="grid grid-cols-12 gap-x-5 mb-5">
            <div class="col-span-12 2xl:col-span-6">
              <InputField
                ...
                title="Tax rate"
                id-value="cafe-form-tax_rate"
                :error="externalErrors.tax_rate && externalErrors.tax_rate[0]"
                :is-required="true"
                typeValue="number"
              />
              <InputField
                v-model="formData.order_limit"
                title="Order limit"
                id-value="cafe-form-order_limit"
                :error="
                  externalErrors.order_limit && externalErrors.order_limit[0]
                "
                :is-required="true"
                typeValue="number"
                class="mt-3"
            ...
            <div class="col-span-12 2xl:col-span-6">
              <InputField
                v-model="formData.order_time_limit"
                title="Order Interval Time (interval between each order times)"
