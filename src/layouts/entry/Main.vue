    ...
    <div class="intro-y box py-10 sm:py-20 mt-5">
      ...
      >
        ...
        >
          <button
            class="w-10 h-10 rounded-full btn"
            :class="isCafe ? 'btn-primary' : 'text-gray-600 bg-gray-200 dark:bg-dark-1'"
          >2</button>
          <div
            :class="isCafe ? 'lg:w-32 font-medium text-base lg:mt-3 ml-3 lg:mx-auto' :
            'lg:w-32 text-base lg:mt-3 ml-3 lg:mx-auto text-gray-700 dark:text-gray-600'"
          >Create Cafe</div>
        </div>
        <div
        ...
        >
          <button
            class="w-10 h-10 rounded-full btn"
            :class="isFinish ? 'btn-primary' : 'text-gray-600 bg-gray-200 dark:bg-dark-1'"
          >3</button>
          <div
